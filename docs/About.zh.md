...
Mycodo 已翻译成多种语言。默认情况下，浏览器的语言将决定使用哪种语言，但可以在 "常规设置 "中的"[齿轮图标] -> 配置 -> 常规 "页面上进行覆盖。如果您发现问题并希望更正翻译或添加其他语言，请访问 [https://translate.kylegabriel.com](https://translate.kylegabriel.com/engage/mycodo/)。
